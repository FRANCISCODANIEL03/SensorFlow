...
// Middleware para permitir conexiones
//desde el frontend
...
app.use(cors()); // Habilita CORS: permite que http://localhost:5173 (React)
//acceda a http://localhost:3001 (API)
app.use(bodyParser.json()); // Permite recibir datos en formato JSON en el cuerpo
